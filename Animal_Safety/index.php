...
<body class="index">
    ...
    <div class="container-fluid my-5 py-5 d-flex justify-content-center">
        ...
        <div class="container m-5 p-5">
            <form action="login.php" class="m-3 p-5 inner" method="post">
                ...
                <div class="container">
                <button class="btn btn-danger mt-3 rounded-pill"><a class="a" href="signup.php">Sign Up</a></button>
                </div>
            </form>
        </div>
    </div>
...
.custom-button {
    margin-top: 20px; /* Increase the margin-top as desired */
    margin-left:10px;
  }
